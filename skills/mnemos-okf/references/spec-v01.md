...
> **Credit.** OKF originates with the upstream
> [GoogleCloudPlatform/knowledge-catalog](https://github.com/GoogleCloudPlatform/knowledge-catalog/tree/main/okf)
> project. This document is mnemos's working v0.1 restatement for agent authoring;
> the upstream project is the reference for the format.
